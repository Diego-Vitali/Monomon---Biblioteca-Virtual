  ...
  return (
    <View style={styles.navContainer}>
      ...
      >
        ...
        />
        <Text
          style={[styles.navText, pathname === "/home" && styles.activeNavText]}
        >
          Início
        </Text>
      </TouchableOpacity>
      ...
      >
        <FontAwesome
          ...
          size={20}
          color={
            pathname === "/catalogo" ? COLORS.primary : COLORS.textSecondary
          }
        />
        <Text
          style={[
            styles.navText,
            pathname === "/catalogo" && styles.activeNavText,
          ]}
        >
          Catálogo
        </Text>
      ...
      >
        ...
        <Text
          style={[
            styles.navText,
            pathname === "/conta" && styles.activeNavText,
          ]}
        >
